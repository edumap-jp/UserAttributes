 ...
 * @return void
 */
	public function testLayout1AndCol1() {
		//テストデータ生成
 ...
 */
	public function testLayout1AndCol2AndWeight1() {
		...
		$viewVars['userAttributes'] = Hash::insert($viewVars['userAttributes'], '{n}.{n}.3.UserAttributeSetting.col', '2');
 ...
 * @return void
 */
	public function testLayout1AndCol2AndWeight2() {
		//テストデータ生成
		$viewVars = $this->__viewVars;
		$viewVars['userAttributes'] = Hash::insert($viewVars['userAttributes'], '{n}.{n}.2.UserAttributeSetting.col', '2');
		$viewVars['userAttributes'] = Hash::insert($viewVars['userAttributes'], '{n}.{n}.2.UserAttributeSetting.weight', '1');
		...
		$viewVars['userAttributes'] = Hash::insert($viewVars['userAttributes'], '{n}.{n}.3.UserAttributeSetting.weight', '3');
		$viewVars['userAttributes'][1][2][2] = $viewVars['userAttributes'][1][1][3];
		unset($viewVars['userAttributes'][1][1][3]);
